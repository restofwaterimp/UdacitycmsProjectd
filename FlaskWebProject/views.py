...
def authorized():
    ...
    if request.args.get('code'):
        ...
        token = _build_msal_app(cache=cache)
        result = token.acquire_token_by_authorization_code(request.args['code'],scopes=Config.SCOPE,redirect_uri=url_for('getAToken', _external=True, _scheme='https'))
...
def _build_auth_url(authority=None, scopes=None, state=None):
    ...
    return _build_msal_app(None, authority=authority).get_authorization_request_url(
        ...
        redirect_uri=url_for('getAToken', _external=True, _schema='https'))
    # return None
